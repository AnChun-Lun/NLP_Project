# This doesn't work due to cloudflare, so this is like a prototype of how I would scrape the website
...
def get_article_links(homepage_url, session):
    ...
    while next_page_url:
        ...
        next_page_button = soup.find('a', attrs={"aria-label": "Next Page"})
...
def scrape_bleepingcomputer():
    homepage_url = 'https://bleepingcomputer.com/'
